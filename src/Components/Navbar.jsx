  ...
  return (
    <div className='relative h-20 w-full px-6 flex justify-between items-center'>
       ...
       {isOpen ? <IoClose /> : <GiHamburgerMenu /> }   
        ...
        { isOpen ? 
            <Navlinks navlinks={navItems} classStyle={'flex flex-col gap-4 absolute left-0 w-screen bg-slate-400 text-white items-center top-20 h-[210px] py-2 z-20 md:hidden'}/> : null
        }
    </div>
  )
}
